function [U_object,X_object,Z_object] = Sequential_step4(priorobj,T_object,lv,u_tot,nu_tot,lnLeval_allyear,dim, k, ISdensity,N)
%{
...
-----------------------------------------------------------------------------------------------
    %}
    fprintf('\nstart Sequential_step4 (with log-scaled input)\n')
